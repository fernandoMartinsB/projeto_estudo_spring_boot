...
public class ClienteUpdateValidator implements ConstraintValidator<ClienteUpdate, ClienteDTO> {
	...
	public boolean isValid(ClienteDTO objDto, ConstraintValidatorContext context) {
		...
		Map<String, String> requestItems = (Map<String, String>) request.getAttribute(HandlerMapping.URI_TEMPLATE_VARIABLES_ATTRIBUTE);
		Integer uriId = Integer.parseInt(requestItems.get("id"));
